    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div className="col-span-1 md:col-span-1">
        ...
        <p className="text-sm text-gray-400">
          Pioneering the future of artificial intelligence with cutting-edge research and innovative solutions.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="/products/ai-platform" className="text-sm hover:text-white transition-colors">AI Platform</a></li>
          <li><a href="/products/machine-learning" className="text-sm hover:text-white transition-colors">Machine Learning</a></li>
          <li><a href="/products/neural-networks" className="text-sm hover:text-white transition-colors">Neural Networks</a></li>
          <li><a href="/products/data-analytics" className="text-sm hover:text-white transition-colors">Data Analytics</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="/research" className="text-sm hover:text-white transition-colors">Research</a></li>
